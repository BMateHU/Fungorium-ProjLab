...
public class GSpore extends JComponent {
    ...
    public void paint(Graphics g) {
        ...
        int offsetY = 10;
        g2d.fillOval(coordX + GTekton.RADIUS - 85, coordY - offsetY, smallCircleDiameter, smallCircleDiameter); // Top small circle
        FontMetrics fm = g2d.getFontMetrics();
        g2d.setColor(Color.BLACK);
        //this add the spore number next to the object
        g2d.drawString(Integer.toString(spore) , coordX + GTekton.RADIUS - 80 , coordY - offsetY - 5);
